...
4. В своем браузере идем на офф. страницу Shadowsocks-rust: shadowsocks-rust и копируем адрес последнего релиза под нашу архитектуру (`shadowsocks-v1.17.1.x86_64-unknown-linux-gnu.tar.xz`).
