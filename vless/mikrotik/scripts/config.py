class ConfigUrls:
    ...
    META_URL_OPEN = "https://iplist.opencck.org/?format=json&data=cidr4&site=messenger.com&site=whatsapp.com&site=instagram.com&site=facebook.com"
    YOUTUBE_URL = "https://raw.githubusercontent.com/touhidurrr/iplist-youtube/refs/heads/main/lists/cidr4.txt"
    YOUTUBE_URL_OPEN = "https://iplist.opencck.org/?format=json&data=cidr4&site=youtube.com"
    ...
    JETBRAINS_URL_OPEN = "https://iplist.opencck.org/?format=json&data=cidr4&site=jetbrains.com&site=jetbrains%40cdn&site=jetbrains%40grazie.ai"
...
class ConfigNames:
    ...
    TWITTER = "twitter"
    YOUTUBE = "youtube"
    WHITE_LIST = [CHATGPT, JETBRAINS, MEDIUM, META, TELEGRAM, TWITTER, YOUTUBE]
